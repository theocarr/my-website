...
function processData(data) {
    if (data.place != null) {
        //only get tweets from us, uk, australia, canada, nz
        if (data.place.country_code == "US" || data.place.country_code == "UK" || data.place.country_code == "AU" || data.place.country_code == "CN" || data.place.country_code == "NZ") {
            tweetText = data.text;
