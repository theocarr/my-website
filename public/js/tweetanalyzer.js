...
function processData(data) {
    if (data.place != null) {
        if (data.place.country_code == "US") {// && data.place.place_type=="city"){// && data.country_code == "NZ") {
...
$('#newTweetButton').on('click', function (e) {
    document.getElementById("tweetText").textContent = tweetText;
    document.getElementById("tweetTitle").textContent = "A Random Tweet by " + tweetUser;
});
